...
const get_deliverers = async (req, res) => {
    try {
...
const get_deliverer_by_id = async (req, res) => {
    try {
        const { id } = req.params;
...
const add_deliverer = async (req, res) => {
    try {
...
const remove_deliverer = async (req, res) => {
    try {
        const { id } = req.params;
...
const update_deliverer = async (req, res) => {
    try {
        const { id } = req.params;
        const { first_name, last_name, tel_number, email, password, dob, id_number } = req.body;
...
//# sourceMappingURL=deliverer.controller.js.map