...
const get_tellers = async (req, res) => {
    try {
...
const get_teller_by_id = async (req, res) => {
    try {
...
const add_teller = async (req, res) => {
    try {
...
const remove_teller = async (req, res) => {
    try {
        const { teller_id } = req.params;
...
const update_teller = async (req, res) => {
    try {
        const { first_name, last_name, tel_number, email, password, dob, id_number } = req.body;
